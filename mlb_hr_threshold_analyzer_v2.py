...
if train_file and live_file:
    ...
    # Impute, encode, convert all as before
    ...
    sfm = SelectFromModel(lgb_for_select, prefit=True, threshold="median")  # Keep top 50%
    ...
    # Optionally show feature importances for audit
